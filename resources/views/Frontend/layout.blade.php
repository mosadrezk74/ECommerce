            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-left">
                ...
                <div class="cellphone hidden-xs">
                  <p><span class="fa fa-phone"></span>+9779815232484</p>
                </div>
                <!-- / cellphone -->
              </div>
              <!-- / header top left -->
              ...
              <div class="col-md-3 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    <h3>Contact Us</h3>
                    <address>
                      <p> Kalaiya-18(Bara) Nepal</p>
                      <p><span class="fa fa-phone"></span>+9815232484</p>
      ...
      <div class="container">
        ...
        <div class="col-md-12">
          <div class="aa-footer-bottom-area">
            <p>Designed by <a href="http://www.markups.io/">Mir Husen Ray</a></p>
