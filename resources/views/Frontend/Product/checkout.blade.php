              ...
              <div class="col-md-8">
                <div class="checkout-left">
                  ...
                  <!-- <div id="order_place_msg"></div> -->
                    ...
                    @endif
                    <!-- Shipping Address -->
                   <h2 align="center"> <div id="order_place_msg"></div></h2>
                        ...
                        <div class="panel-body">
                         <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="aa-checkout-single-bill">
                              <p class="coupon-style">Address</p>
