                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-info">
                                        ...
                                        <div class="detail-extralink">
                                            <input type="number"  name="quantity" value="1" style="width: 100px ; height: 40px ;">
                                            <a href="{{ route('add_to_cart', $product->id) }}"
                                               class="button button-add-to-cart" role="button" style="background-color: white ; color: #0a53be ">
                                                Add to cart
                                            </a>
